...
``` {r echo=FALSE, Diapositiva1, fig.align = 'right', out.width = "30%"}
...
```{r echo=FALSE, Diapositiva6, fig.align = 'right', out.width = "50%", fig.cap = "Data Model"}
...
```{r echo=FALSE, Diapositiva7, fig.align = 'right', out.width = "50%", fig.cap = "Data Science"}
